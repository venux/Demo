(function () {   
    ...
    developPaths.communityURL = 'http://www.cuuju.com/';//社区站点
    developPaths.matchURL = 'http://match.cuuju.com/';//赛事子站点
    developPaths.clubURL = 'http://club.cuuju.com/';//球队子站点
    developPaths.organURL = 'http://organ.cuuju.com/';//主办商子站点
    developPaths.venueURL = 'http://venue.cuuju.com/';//场地子站点
    developPaths.judgeURL = '';//裁判子站点（暂无）
    developPaths.appURL = 'http://app.cuuju.com/';//APP子站点
    developPaths.serviceURL = '';//服务子站点（暂无）
    developPaths.activeURL = 'http://active.cuuju.com/cuju/atList.htm';//活动子站点
    ...
    window.CujuURLModel = developPaths;
    ...
    //window.CujuURLModel = GetPathByType(type);
